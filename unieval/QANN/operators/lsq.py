"""LSQ quantization modules: MyQuan, QAttention, QuanConv2d, QuanLinear.

STE helper functions and KL-divergence threshold optimization are also here
as they are used by both LSQ and PTQ modules.
"""
...
from .composites import QConv2d as QCompConv2d, QLinear as QCompLinear, QNorm
